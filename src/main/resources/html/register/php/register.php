...
//链接数据库
$link = mysql_connect("http://zhuaowei.top:8081/user/register","root","123456");
...
$sql1 = "INSERT INTO users(username,password,nickname,create_time) VALUES('{$username}','{$password}',{$nickname},{$create_time})";
